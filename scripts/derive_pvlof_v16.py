"""Derive PVLOF v1.6 hybrid-gate calibration and memory configuration."""
...
from pv_anomaly.pvlof_v16 import PVLOFV16MemoryConfig, save_memory_config
...
def main() -> None:
    ...
    parser.add_argument("--version", default="pvlof-v1.6-hybrid-gate")
    ...
    if args.minimum_absolute_drop <= 0:
        raise ValueError("--minimum-absolute-drop must be positive")
    ...
    report = {
        ...
        "version": args.version,
        "isolated_effect_gate_mode": base.isolated_effect_gate_mode,
        ...
        "isolated_effect_rule": "relative_drop >= threshold OR absolute_drop >= threshold",
        "lof_still_required": True,
